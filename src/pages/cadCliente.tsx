...
export default function CadCliente() {
    ...
    const cadastrar = async () => {
        if(nomeEmpresa =="") setNomeEmpresaError(true)
        ...
        if(nomeEmpresa =="" || nomeRepres =="" || contRepres =="" || userName =="" || userName.length<5|| 
                ...
                <div className="md:mt-6">
                    ...
                    <form className="mt-8" x-data="{password: '',password_confirm: ''}">
                        <div className="mx-auto max-w-lg ">
                            <div className="py-1">
                                <span className="px-1 text-sm text-gray-600">Nome Empresa</span>
                                <input placeholder="" type="text"
                                       className="text-md block px-3 py-2 rounded-lg w-full
                                            ...
                                            onChange={(e) => {
                                                ...
                                                setNomeEmpresaError(false)
                                            }}/>    
                                {(nomeEmpresaError)?<p className="text-red-600 text-xs">Campo Obrigatorio</p>: <p> </p>}
                            </div>
                            <div className="py-1">
                                <span className="px-1 text-sm text-gray-600">Nome Representante</span>
                                <input placeholder="" type="text"
                                       className="text-md block px-3 py-2 rounded-lg w-full
                                    bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md
                                     focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
                            ...
                            <div className="py-1">
                                <span className="px-1 text-sm text-gray-600">Contato Representante</span>
                                <input placeholder="" type="text"
                                       className="text-md block px-3 py-2 rounded-lg w-full
                                    bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md 
                                    focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none"
